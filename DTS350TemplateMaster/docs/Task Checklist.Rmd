...
- [ x] The number of tasks I completed on time:24
- [ x] The number of Case Studies I completed on time: 11
- [ x] The number of times I was a team lead for a team meeting: 3
- [ x] The total number of tasks I completed: 24
- [x ] The total number of Case Studies I completed: 11
...
- [x ] Take notes on your reading of the new R package in the README.md or in a .R script in the class task folder.
- [x ] Create or recreate an animated graphic.
- [x ] Push your `.Rmd` and `.html` files to your GitHub repo.